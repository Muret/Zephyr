...
Tengri::MeshInstance::MeshInstance()
{
}
...
Tengri::MeshSection::MeshSection(BaseMesh *base_mesh) : base_mesh_(base_mesh)
{
}

Tengri::MeshSection::~MeshSection()
{
}

inline void Tengri::MeshSection::set_indices(const std::vector<int>& ind)
{
	indices_ = ind;
}

BoundingBox Tengri::MeshSection::get_bounding_box() const
{
	BoundingBox bb;
...
void Tengri::GreyWolf::set_scene(Scene * scene)
{
...
void Tengri::GreyWolf::tick(float dt)
{
}

inline void Tengri::GreyWolf::gbuffer_render()
{
	...
	//fill instance buffers for sections
...
inline void Tengri::GreyWolf::add_instance(MeshInstance * instance)
{
...
inline Tengri::BaseMesh* Tengri::GreyWolf::pre_compute_mesh_sections(Mesh * mesh)
{
...
Tengri::BaseMesh::BaseMesh(Mesh *m)
{
	original_mesh = m;
}

Tengri::BaseMesh::~BaseMesh()
{
}

void Tengri::BaseMesh::add_mesh_section(MeshSection * s)
{
	sections.push_back(s);
}

inline Mesh * Tengri::BaseMesh::get_original_mesh() const
{
